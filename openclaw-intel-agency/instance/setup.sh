...
# -----------------------------------------------------------------------------
# STEP 2: Verify research directory exists
# -----------------------------------------------------------------------------
echo "💾 Verifying /mnt/disks/research directory..."

if [ ! -d /mnt/disks/research ]; then
    echo "❌ ERROR: /mnt/disks/research does not exist"
    echo "   The startup script should have created it automatically."
    echo "   Check: cat /var/log/startup-script.log"
    exit 1
fi

echo "✅ Research directory exists at /mnt/disks/research"
df -h /mnt/disks/research

# Ensure all required directories exist
sudo mkdir -p /mnt/disks/research/{workspace,logs,vector_db,.secrets}
sudo chown -R $(id -u):$(id -g) /mnt/disks/research
...
# -----------------------------------------------------------------------------
# TAVILY SEARCH API (Recommended for web search)
# -----------------------------------------------------------------------------
...
echo "      - TAVILY_API_KEY (from tavily.com)"
